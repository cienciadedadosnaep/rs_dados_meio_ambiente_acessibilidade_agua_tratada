...
df = pd.read_csv('E:/Área de trabalho/Códigos/R/rs_dados_meio_ambiente_acessibilidade_agua_tratada/data/POVOAMENTO.csv', sep = ';')
...
for i in range(0,len(df)):
    ...
    code = list(pd.read_csv('E:/Área de trabalho/Códigos/R/rs_dados_meio_ambiente_acessibilidade_agua_tratada/data/'+codigol1[i],sep=';', encoding= 'latin-1'))
